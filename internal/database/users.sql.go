...
func (q *Queries) UpdateUserRedStatus(ctx context.Context, arg UpdateUserRedStatusParams) (User, error) {
	row := q.db.QueryRowContext(ctx, updateUserRedStatus, arg.ID, arg.IsChirpyRed)
	var i User
	err := row.Scan(
		&i.ID,
		&i.CreatedAt,
